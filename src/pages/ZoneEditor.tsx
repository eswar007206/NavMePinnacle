...
function dbToEditor(db: DbZone): EditorZone {
  return { dbId: db.id, zone_id: db.zone_id, label: db.label, x: db.x, y: db.y, w: db.w, h: db.h, floor: db.floor };
}
                ...
                return (
                  <g key={z.zone_id}>
                    <rect
                      ...
                      width={z.w}
                      height={z.h}
                      fill={isSel ? "rgba(59, 130, 246, 0.35)" : "rgba(34, 197, 94, 0.3)"}
            ...
            {floorZones.length === 0 ? (
              ...
              <div className="space-y-1 max-h-[300px] overflow-y-auto">
                {floorZones.map((z) => (
                  ...
                  >
                    <span className="w-2.5 h-2.5 rounded-sm shrink-0" style={{ background: z.zone_id === selectedId ? "#3b82f6" : "#22c55e" }} />
