/**
 * Map coordinate conversion for ground floor plan (792×612 image).
...
export const FLOOR_IMG_WIDTH = 792;
export const FLOOR_IMG_HEIGHT = 612;

/** Cropped viewBox to remove blank margins on the floor plan image. */
export const FLOOR_CROP_Y = 50;
export const FLOOR_CROP_W = FLOOR_IMG_WIDTH;
export const FLOOR_CROP_H = 465;
